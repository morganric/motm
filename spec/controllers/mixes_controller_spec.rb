  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved mix as @mix" do
        ...
        post :create, {:mix => { "title" => "invalid value" }}, valid_session
        assigns(:mix).should be_a_new(Mix)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested mix" do
        ...
        Mix.any_instance.should_receive(:update_attributes).with({ "title" => "MyString" })
        put :update, {:id => mix.to_param, :mix => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the mix as @mix" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Mix.any_instance.stub(:save).and_return(false)
        put :update, {:id => mix.to_param, :mix => { "title" => "invalid value" }}, valid_session
        assigns(:mix).should eq(mix)
      end
